...
var transportationMode = ["Car", "Bike", "Bus", "Aeroplane", "Cycle"];
transportationMode.map(function (Mode) { return console.log("I would like to own a ".concat(Mode)); });
//Map method sub ko aik aik kar kay call karega ye for Each ki trah kam krta hai.
